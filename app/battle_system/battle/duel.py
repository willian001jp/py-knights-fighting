...
class Duel:
    ...
    def fight(self) -> Tuple[int, int]:
        ...
        self.log.append(f"{self.knight1.name} hits {self.knight2.name} for {damage1} damage")
        self.log.append(f"{self.knight2.name} hits {self.knight1.name} for {damage2} damage")
